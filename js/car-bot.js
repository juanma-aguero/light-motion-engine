...
carBot.prototype.think = function() {
    ...
    var objectsInSight = this.motionEngine.giveMeWhatISee(this);

    // explore
//    if( (this.counter % 2) == 0 ){
//        
//        for(var i=0; i<objectsInSight.length; i++){
//            var ang = this.motionEngine.getAngleToFollow(this, objectsInSight[i]);
//            if( ang > (this.activeAngle-10) &&  ang < (this.activeAngle+10) ){
//                this.activeAngle = Math.floor(Math.random() * 360);
//                this.color = '#' + (Math.random() * 0xFFFFFF << 0).toString(16);
//            }
//			
